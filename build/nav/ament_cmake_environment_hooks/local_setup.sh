...
: ${AMENT_CURRENT_PREFIX:="/home/tharun/smoothing-rpp/install/nav"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav/environment/pythonpath.sh"
